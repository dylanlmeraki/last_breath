...
export const marketingRouteImages = {
  ...
  consultationHero: "/images/projects/caltrans-stormwater-ada-improvements-01.jpg",
  ...
  servicesHero: "/images/projects/sfpuc-water-infrastructure-swppp-02.jpg",
  servicesOverviewHero: "/images/projects/sfo-terminal-3-boarding-area-e-01.jpg",
...
export const marketingTeamAssetManifest: Record<TeamId, MarketingTeamAssetEntry> = {
  "mark-waldman": {
    ...
    alt: "Pacific Engineering leadership profile placeholder for A. Mark Waldman.",
    caption: "Principal engineer (Lic. #: 12341234558) with extensive engineering and construction experience.",
...
export const marketingBlogAssetManifest: Record<BlogSlug, MarketingBlogAssetEntry> = {
  "what-bay-area-teams-miss-when-swppp-planning-starts-too-late": {
    ...
    routeFamily: "blog",
    publicUrl: "/images/projects/caltrans-stormwater-ada-improvements-02.jpg",
    featuredImage: "/images/projects/caltrans-stormwater-ada-improvements-02.jpg",
    alt: "Stormwater field conditions supporting Bay Area SWPPP preconstruction planning.",
    caption: "SWPPP planning guidance.",
    sourceNote:
      `${PHASE5B_PDF_SOURCE}; editorial re-selection from Caltrans stormwater-focused source imagery for blog delivery context.`,
    status: "provisional",
    fallbackKey: "route-bay-bridge-fallback",
  },
  "special-inspection-coordination-that-actually-helps-the-schedule": {
    ...
    routeFamily: "blog",
    publicUrl: "/images/routes/construction-hero.jpg",
    featuredImage: "/images/routes/construction-hero.jpg",
    alt: "Active Bay Area utility trench work supporting special inspection sequencing context.",
    caption: "Special inspection coordination guidance.",
    sourceNote:
      `${PHASE5B_PDF_SOURCE}; editorial re-selection from field construction source imagery for special inspection coordination context.`,
    status: "provisional",
    fallbackKey: "route-bay-bridge-fallback",
  },
  "field-driven-engineering-decisions-save-more-than-redlines": {
    ...
    routeFamily: "blog",
    publicUrl: "/images/routes/structural-hero.jpg",
    featuredImage: "/images/routes/structural-hero.jpg",
    alt: "Plan-driven engineering visual supporting constructability-focused project decisions.",
    caption: "Field-driven engineering guidance.",
    sourceNote:
      `${PHASE5B_PDF_SOURCE}; editorial re-selection from engineering documentation imagery for technical article tone.`,
    status: "provisional",
    fallbackKey: "route-bay-bridge-fallback",
  },
};
