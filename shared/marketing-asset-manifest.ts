...
export const marketingTeamAssetManifest: Record<TeamId, MarketingTeamAssetEntry> = {
  "mark-waldman": {
    ...
    alt: "A. Mark Waldman, principal engineer and project manager at Pacific Engineering.",
    caption: "Principal engineer (Lic. #: 12341234558) with extensive engineering and construction experience.",
    sourceNote: "Approved local headshot provided by Pacific Engineering leadership.",
    status: "approved",
