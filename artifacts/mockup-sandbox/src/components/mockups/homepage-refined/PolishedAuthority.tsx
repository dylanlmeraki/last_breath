...
export default function PolishedAuthority() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-900 font-sans" data-testid="page-home-polished">
            ...
            <div className="relative bg-slate-900/40 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden mt-10">
              ...
              <div className="p-6 sm:p-10 md:p-12 lg:p-16">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-6">
                  <button className="group inline-flex items-center justify-center gap-2 whitespace-nowrap text-white font-bold tracking-tight text-lg px-8 py-4 rounded-lg bg-orange-600 hover:bg-orange-500 shadow-lg hover:shadow-xl transition-all duration-300" data-testid="btn-hero-quote">
                ...
                <p className="text-slate-400 text-sm md:text-base tracking-wide mb-16" data-testid="text-hero-trust">
      ...
      <section className="py-32 px-6 bg-white border-b border-slate-200" data-testid="section-services">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            <div className="group h-full bg-slate-50/50 rounded-2xl shadow-md border border-slate-100 transition-all duration-300 overflow-hidden" data-testid="card-engineering">
            ...
            <div className="group h-full bg-white rounded-2xl shadow-xl hover:shadow-2xl border border-slate-200 transition-all duration-300 overflow-hidden relative z-10" data-testid="card-stormwater">
              ...
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-slate-100 rounded-2xl w-24 h-24 flex items-center justify-center mb-8">
      ...
      {/* 3. WHY PACIFIC - Left aligned, warm amber background */}
