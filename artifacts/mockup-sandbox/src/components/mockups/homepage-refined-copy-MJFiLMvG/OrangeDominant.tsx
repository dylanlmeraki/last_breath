    ...
    <div className="fixed inset-0 z-50 bg-slate-950/95 backdrop-blur-md">
      ...
      <nav className="flex flex-col px-8 py-6 space-y-1">
        {["Home", "Services", "About Us", "Previous Work", "Gallery", "Contact"].map((item) => (
          <a key={item} href="#" className="text-lg text-slate-200 hover:text-orange-400 py-3 border-b border-slate-800 transition-colors font-medium">{item}</a>
        ))}
        <div className="pt-6 space-y-3">
          ...
          <button className="w-full py-4 rounded-lg bg-slate-700 text-white font-bold text-lg flex items-center justify-center gap-2">
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
        ...
        <div className="absolute bottom-16 right-0 w-80 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden mb-2">
          <div className="bg-orange-600 px-5 py-4 flex items-center justify-between">
            <div>
              ...
              <div className="text-orange-100 text-xs">Typically replies within 1 hour</div>
            </div>
          ...
          <div className="p-5">
            ...
            <div className="flex gap-2">
              <input placeholder="Type a message..." className="flex-1 text-sm border border-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500/40" />
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-orange-600 hover:bg-orange-500 text-white shadow-lg shadow-orange-500/30 flex items-center justify-center transition-all hover:scale-105"
...
export default function OrangeDominant() {
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <div className="min-h-screen bg-white font-sans" data-testid="page-home-orange-dominant">
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs font-medium text-orange-300 tracking-wide">Consulting Engineers & Contractors</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a href="tel:4155550100" className="hidden md:inline-flex items-center gap-2 text-orange-400 font-bold text-sm hover:text-orange-300 transition-colors">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 pt-20" data-testid="section-hero">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-orange-950/40 via-transparent to-cyan-950/15 opacity-60" />
          <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:40px_40px]" />
        </div>

        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-orange-500/10 rounded-full blur-[120px] pointer-events-none z-0" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none z-0" />

        <div className="relative z-10 w-full px-4 sm:px-10 py-12">
          <div className="mx-auto w-full max-w-5xl text-center">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 rounded-2xl opacity-5 blur-sm" />

              <div className="relative bg-slate-900/80 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500" />

                <div className="p-6 sm:p-10 md:p-12 lg:p-16">
                  <div className="flex justify-center mb-8">
                    <img src="/images/pe-logo.png" alt="Pacific Engineering Logo" className="h-20 w-20 sm:h-24 sm:w-24 rounded-xl object-contain shadow-lg border-2 border-white/10" />
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-4 my-6 sm:my-8">
                    <div className="h-px w-16 sm:w-24 bg-gradient-to-r from-transparent to-orange-500" />
                    <div className="w-3 h-3 rotate-45 bg-cyan-400" />
                    <div className="h-px w-16 sm:w-24 bg-gradient-to-l from-transparent to-orange-500" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    <div className="group relative rounded-xl bg-white/5 border border-white/10 hover:border-orange-500/40 transition-all duration-300 hover:bg-white/10 p-6 flex flex-col items-center justify-center" data-testid="stat-experience">
                    ...
                    <div className="group relative rounded-xl bg-slate-800/80 border-2 border-orange-500/40 shadow-xl p-6 md:scale-105 flex flex-col items-center justify-center z-10" data-testid="stat-full-service">
                    ...
                    <div className="group relative rounded-xl bg-white/5 border border-white/10 hover:border-orange-500/40 transition-all duration-300 hover:bg-white/10 p-6 flex flex-col items-center justify-center" data-testid="stat-full-scale">
      ...
      <div className="h-1 bg-gradient-to-r from-orange-500 via-amber-400 to-cyan-500" />
      ...
      <section className="py-24 sm:py-32 px-6 bg-white border-b border-slate-200" data-testid="section-services">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <div className="w-32 h-1.5 bg-gradient-to-r from-orange-500 to-cyan-400 mx-auto mb-8 rounded-full"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            <div className="group h-full bg-slate-50/50 rounded-2xl shadow-md hover:shadow-xl border border-slate-100 transition-all duration-300 overflow-hidden cursor-pointer hover:-translate-y-2" data-testid="card-engineering">
              <div className="h-1 bg-gradient-to-r from-amber-500 to-orange-400 opacity-80" />
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-amber-100 rounded-2xl w-24 h-24 flex items-center justify-center mb-8 group-hover:bg-gradient-to-br group-hover:from-amber-400 group-hover:to-amber-600 group-hover:shadow-lg transition-all duration-300">
                  <ClipboardCheck className="w-12 h-12 text-amber-600 group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-slate-900 text-2xl font-bold mb-4 uppercase tracking-wider group-hover:text-amber-600 transition-colors">Engineering Consulting</h3>
            ...
            <div className="group h-full bg-slate-50/50 rounded-2xl shadow-md hover:shadow-xl border border-slate-100 transition-all duration-300 overflow-hidden cursor-pointer hover:-translate-y-2" data-testid="card-inspections">
              ...
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-cyan-50 rounded-2xl w-24 h-24 flex items-center justify-center mb-8 group-hover:bg-gradient-to-br group-hover:from-cyan-400 group-hover:to-cyan-600 group-hover:shadow-lg transition-all duration-300">
                  <ClipboardCheck className="w-12 h-12 text-cyan-700 group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-slate-900 text-2xl font-bold mb-4 uppercase tracking-wider group-hover:text-cyan-600 transition-colors">Inspections & Testing</h3>
            ...
            <div className="group h-full bg-white rounded-2xl shadow-xl hover:shadow-2xl border border-slate-200 transition-all duration-300 overflow-hidden relative z-10 cursor-pointer hover:-translate-y-2" data-testid="card-stormwater">
              ...
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-slate-100 rounded-2xl w-24 h-24 flex items-center justify-center mb-8 group-hover:bg-gradient-to-br group-hover:from-slate-500 group-hover:to-slate-700 group-hover:shadow-lg transition-all duration-300">
                  <FileText className="w-12 h-12 text-slate-700 group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-slate-900 text-2xl font-bold mb-4 uppercase tracking-wider group-hover:text-slate-600 transition-colors">Stormwater Planning</h3>
      ...
      <section className="py-16 sm:py-20 px-6 bg-orange-50/50 relative overflow-hidden" data-testid="section-why-choose">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="bg-gradient-to-r from-orange-500 to-cyan-400 my-8 w-24 h-1.5 rounded-full"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="inline-flex items-center justify-center gap-2 text-white font-bold tracking-tight text-lg px-8 py-4 rounded-lg bg-orange-600 hover:bg-orange-500 shadow-lg hover:shadow-xl transition-all duration-300 group" data-testid="btn-scope-project">
            ...
            <div className="relative mt-12 lg:mt-0 px-4 sm:px-8">
              ...
              <div className="absolute -bottom-6 -right-2 sm:-right-6 bg-gradient-to-br from-orange-500 to-amber-600 p-8 rounded-2xl shadow-xl border-4 border-white flex flex-col items-center justify-center z-20">
                ...
                <div className="text-orange-50 font-bold uppercase tracking-widest text-xs sm:text-sm">Successful Projects</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-slate-900 relative border-t-4 border-orange-500 overflow-hidden" data-testid="section-cta">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <p className="text-orange-400 font-bold uppercase tracking-widest text-sm sm:text-base mb-4">Ready to move?</p>
          ...
          <div className="w-48 h-1.5 bg-gradient-to-r from-orange-500 to-cyan-400 mx-auto mb-10 rounded-full"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-12">
            ...
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-white font-bold tracking-tight text-xl px-10 py-5 rounded-xl bg-slate-800 hover:bg-slate-700 shadow-lg hover:shadow-xl border border-slate-700 transition-all duration-300 group" data-testid="btn-cta-call">
