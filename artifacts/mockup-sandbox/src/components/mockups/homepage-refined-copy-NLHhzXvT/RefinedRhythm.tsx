...
export default function RefinedRhythm() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-900 font-sans" data-testid="page-home-refined">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 py-12 sm:py-16 md:py-20 lg:py-24" data-testid="section-hero">
        ...
        {/* Glow effects */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none z-0" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-500/10 rounded-full blur-[120px] pointer-events-none z-0" />
            ...
            <div className="relative bg-slate-900/40 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden mt-10">
              ...
              <div className="p-6 sm:p-10 md:p-12 lg:p-16">
                <h1 className="text-white font-bold tracking-tighter leading-[1.1] text-4xl sm:text-5xl md:text-7xl lg:text-8xl mb-6" data-testid="text-hero-title">
                  <span className="bg-gradient-to-r from-white via-slate-100 to-white bg-clip-text">
                    Pacific Engineering
                  </span>{" "}
                  <br />
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-16">
                  <button className="group inline-flex items-center justify-center gap-2 whitespace-nowrap text-white font-bold tracking-tight text-lg px-8 py-4 rounded-lg bg-orange-600 hover:bg-orange-500 shadow-[0_0_20px_rgba(234,88,12,0.4)] hover:shadow-[0_0_25px_rgba(249,115,22,0.6)] transition-all duration-300" data-testid="btn-hero-services">
                    Our Services
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
                  </button>
                  <button className="group inline-flex items-center justify-center gap-2 whitespace-nowrap text-white font-bold tracking-tight text-lg px-8 py-4 rounded-lg bg-cyan-600 hover:bg-cyan-500 shadow-[0_0_20px_rgba(8,145,178,0.4)] hover:shadow-[0_0_25px_rgba(6,182,212,0.6)] transition-all duration-300" data-testid="btn-hero-consultation">
                    Free Consultation
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  ...
                  <div className="group relative rounded-xl bg-slate-800/80 border-2 border-orange-500/50 shadow-[0_0_30px_rgba(249,115,22,0.15)] p-6 md:scale-105 flex flex-col items-center justify-center z-10" data-testid="stat-full-service">
      ...
      <div className="h-2 bg-gradient-to-r from-cyan-500 to-orange-500" />
      ...
      <section className="py-32 px-6 bg-white border-b border-slate-200" data-testid="section-services">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            <div className="group h-full bg-white rounded-2xl shadow-xl hover:shadow-2xl border border-slate-200 transition-all duration-300 overflow-hidden relative z-10" data-testid="card-construction">
              <div className="h-2 bg-gradient-to-r from-orange-500 to-amber-400" />
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-orange-50 rounded-2xl w-24 h-24 flex items-center justify-center mb-8 shadow-inner">
            ...
            <div className="group h-full bg-slate-50/50 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all duration-300 overflow-hidden" data-testid="card-engineering">
              <div className="h-1 bg-gradient-to-r from-amber-400 to-yellow-400 opacity-70 group-hover:opacity-100" />
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-amber-50 rounded-2xl w-24 h-24 flex items-center justify-center mb-8">
            ...
            <div className="group h-full bg-slate-50/50 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all duration-300 overflow-hidden" data-testid="card-inspections">
              <div className="h-1 bg-gradient-to-r from-emerald-400 to-teal-400 opacity-70 group-hover:opacity-100" />
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-teal-50 rounded-2xl w-24 h-24 flex items-center justify-center mb-8">
                ...
                <ul className="space-y-4 w-full flex flex-col items-center">
                  {[
                    ...
                    <li key={i} className="flex items-center justify-center gap-3 text-slate-600 w-full">
                      <CheckCircle className="w-6 h-6 text-teal-500 flex-shrink-0 opacity-80" />
                      <span className="font-medium text-lg">{item}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="group h-full bg-white rounded-2xl shadow-xl hover:shadow-2xl border border-slate-200 transition-all duration-300 overflow-hidden relative z-10" data-testid="card-stormwater">
              <div className="h-2 bg-gradient-to-r from-cyan-500 to-blue-500" />
              <div className="p-10 flex flex-col items-center text-center">
                <div className="bg-cyan-50 rounded-2xl w-24 h-24 flex items-center justify-center mb-8 shadow-inner">
      ...
      {/* 4. CTA SECTION - Punchy padding (py-20), dark background */}
      <section className="py-20 px-6 bg-slate-900 relative border-t-8 border-orange-500 overflow-hidden" data-testid="section-cta">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="w-48 h-2 bg-gradient-to-r from-orange-500 via-orange-400 to-amber-500 mx-auto mb-10 rounded-full shadow-[0_0_15px_rgba(249,115,22,0.5)]"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-white font-bold tracking-tight text-xl px-10 py-5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:shadow-[0_0_40px_rgba(249,115,22,0.5)] transition-all duration-300 group" data-testid="btn-cta-contact">
              <Phone className="w-6 h-6" />
              Get In Touch
            </button>
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-white font-bold tracking-tight text-xl px-10 py-5 rounded-xl bg-transparent border-2 border-slate-600 hover:border-slate-400 hover:bg-slate-800 transition-all duration-300 group" data-testid="btn-cta-services">
