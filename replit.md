...
**Components (14)**: AnimatedGridBackground, AnimatedSection (parallax support), BackToTop (50% scroll threshold), BlueprintBackground, ChatBot (draggable, scroll-aware, auto-prompt, auto-opens on desktop), FloatingElements (architectural blueprint SVGs), FooterBackground, GlowingCard, ParticleField, ScrollFadeSection, SectionDivider (angled/wave/gradient/blueprint variants), SEO, ShinyButton
