...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full text-[#2828d1e6] bg-[#0f172a00] border-t-[#e5e7eb00] border-r-[#e5e7eb00] border-b-[#e5e7eb00] border-l-[#e5e7eb00]" style={{ height: "clamp(30px,4vw,60px)", marginBottom: "-1px" }}>
